                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header" style="display: flex;justify-content: space-between;">
                            <h4>{{$module_name}}</h4>
                            <a href="{{route('admin.employment.excel',request()->all())}}" target="_blank">Excel</a>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    @foreach($employments as $employment)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{route("admin.employment.edit",['employment'=>$employment['id']])}}" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                                                @endcan
                                                                @can("delete_employment")
                                                                <a href="javascript:void(0)" data-href="{{route("admin.employment.destroy",['employment'=>$employment['id']])}}" class="btn btn-danger btn-sm delete"><i class="fas fa-trash"></i></a>
                                                                @endcan
                                                            </td>
                                                        </tr>
                                                    @endforeach
